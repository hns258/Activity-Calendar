    ...
    image_folder_settings: [
      {
        activity_folder_location:
          temp2Obj.image_folder_settings[0].activity_folder_location,
        people_folder_location:
          temp2Obj.image_folder_settings[0].people_folder_location,
        popular_folder_location:
          temp2Obj.image_folder_settings[0].popular_folder_location,
        transport_folder_location:
          temp2Obj.image_folder_settings[0].transport_folder_location,
      },
    ],
  ...
  setTimeout(() => {
    ...
    switch (locationType) {
      case 'PEOPLE':
        ...
        settingsTemp.image_folder_settings[0].people_folder_location =
          folderStr;
      ...
      case 'TRANSPORT':
        ...
        settingsTemp.image_folder_settings[0].transport_folder_location =
          folderStr;
        console.log(`temp being saved:\n ${JSON.stringify(settingsTemp)}`);
        save(settingsTemp);
        break;
      case 'POPULAR':
        ...
        settingsTemp.image_folder_settings[0].popular_folder_location =
          folderStr;
        console.log(`temp being saved:\n ${JSON.stringify(settingsTemp)}`);
        save(settingsTemp);
        break;
      case 'ACTIVITY':
        ...
        settingsTemp.image_folder_settings[0].activity_folder_location =
          folderStr;
        console.log(`temp being saved:\n ${JSON.stringify(settingsTemp)}`);
        save(settingsTemp);
        break;
  ...
  if (page === 'settings.html') {
    ...
    xhr.onreadystatechange = () => {
      ...
      if (xhr.readyState === 4 && xhr.status === 200) {
        ...
        locationDisplays[0].innerHTML =
          settingsJSON.image_folder_settings[0].people_folder_location;
        locationDisplays[1].innerHTML =
          settingsJSON.image_folder_settings[0].transport_folder_location;
        locationDisplays[2].innerHTML =
          settingsJSON.image_folder_settings[0].popular_folder_location;
        locationDisplays[3].innerHTML =
          settingsJSON.image_folder_settings[0].activity_folder_location;
      }
      if (xhr.readyState === 4 && xhr.status !== 200) {
